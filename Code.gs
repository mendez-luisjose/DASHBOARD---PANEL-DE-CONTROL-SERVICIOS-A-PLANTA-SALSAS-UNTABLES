 ...
 */
const BACKEND_VERSION = 'V7-2026-09-24';
...
function doGet(e){
  ...
  try{
    ...
    if(action==='health') payload={ok:true,service:'Dashboard Servicios · Google Drive',version:BACKEND_VERSION,acceptedAreas:Object.keys(AREA_ALIASES),supportsAppendSala:true,supportsSalaV5:true,supportsSalaV6:true,supportsNewPtabVaporVars:true,time:new Date().toISOString()};
